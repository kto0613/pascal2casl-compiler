...
/**
 * CheckerParseData クラスです。
 */
final class CheckerParseData {
	/**トークンID*/
	...
	/**
	 * CheckerParseData クラスのコンストラクタです。
	 * @param tokenID
	 * トークンID
	 * @param lineNum
	 * 行番号
	 */
	CheckerParseData(String string, int tokenID, int lineNum) {
		this.string = string;
